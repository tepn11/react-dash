...
import { Dashboard, Dataset } from 'react-dash'
let _settings;
...
class Dash extends Dashboard {
  getDashboardData(_appliedFilters) {
    ...
    dataKeys.forEach(dataKey => {
      ...
      // Note that, because of the shape of our data and the need for custom processing,
        // that we do our filtering AFTER we fetch. In other cases (The DKAN Dash implementation
        // for example),  we use the appropriate filters to update our API calls to return filtered
        // data. The details of implementation are up to you, but we suggest you stick with the
        // appliedFilters pattern, which maintains the proper top down data flow
